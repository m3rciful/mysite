...
<div class="container">
    ...
    <h3>Ученики:</h3><a href="<?php echo $mysite;?>/index.php/addnewstudent">добавить нового ученика</a><br>
    <a href="<?php echo $mysite;?>/index.php/addstudent?id=<?php echo $data['group']->getId() ?>">добавить существующего ученика в группу</a>
    <ul class="list-group">
